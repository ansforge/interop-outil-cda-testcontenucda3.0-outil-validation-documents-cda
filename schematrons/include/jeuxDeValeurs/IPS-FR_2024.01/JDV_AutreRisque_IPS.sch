...
<!-- JDV_AutreRisque_IPS.sch (spécialisation du pattern dansJeuDeValeurs.sch)
    
    Contenu :
        Contrôle du code d'une entrée FR-Evaluation
        
    Paramètres d'appel :
        "path_jdv" : chemin relatif du fichier jeu de valeurs (ici JDV_AutreRisque_IPS a été valorisé à ../../jeuxDeValeurs/JDV_Autre_Risque_CISIS.xml dans le schématron CI-SIS_StructurationMinimale.sch)
